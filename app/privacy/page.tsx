...
export default function PrivacyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <div className="mb-12">
        <p className="text-xs uppercase tracking-widest text-sage-600 mb-3">{tr.privacy_eyebrow}</p>
        <h1 className="font-playfair text-4xl text-stone-900 mb-4">{tr.privacy_heading}</h1>
        <p className="text-stone-500 text-sm">{tr.privacy_updated}</p>
      </div>

      {lang === 'fr' ? (
        <div className="prose prose-stone max-w-none space-y-10 text-stone-600 text-[0.95rem] leading-relaxed">

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">1. Qui nous sommes</h2>
            <p>
              The Heartwear Store («&nbsp;nous&nbsp;», «&nbsp;notre&nbsp;» ou «&nbsp;nos&nbsp;») exploite le site web{' '}
              <span className="font-medium text-stone-700">www.theheartwearstore.ca</span>. Nous sommes une marque canadienne de vêtements imprimés à la demande. Cette politique de confidentialité explique comment nous collectons, utilisons et protégeons vos renseignements personnels lorsque vous visitez notre site ou effectuez un achat.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">2. Renseignements que nous collectons</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">3. Utilisation de vos renseignements</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">4. Services tiers</h2>
            <p>Nous collaborons avec des partenaires de confiance pour fournir notre service :</p>
            <ul className="list-disc pl-5 space-y-1.5">
              <li><span className="font-medium text-stone-700">Stripe</span> — traitement des paiements. Vos données de paiement sont entièrement gérées par Stripe et sont soumises à leur politique de confidentialité.</li>
              <li><span className="font-medium text-stone-700">Printify</span> — impression et exécution. Votre adresse de livraison est partagée avec Printify pour produire et expédier votre commande.</li>
              <li><span className="font-medium text-stone-700">Netlify</span> — hébergement du site web.</li>
              <li><span className="font-medium text-stone-700">Supabase</span> — base de données sécurisée pour les dossiers de commandes.</li>
            </ul>
            <p>Chacun de ces services opère selon ses propres politiques de confidentialité et pratiques de protection des données.</p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">5. Conservation des données</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">6. Vos droits</h2>
            ...
            <p>Pour exercer l'un de ces droits, veuillez nous contacter à <a href="mailto:hello@theheartwearstore.ca" className="text-stone-800 underline underline-offset-2 hover:text-stone-900">hello@theheartwearstore.ca</a>.</p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">7. Témoins (cookies)</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">8. Modifications de cette politique</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">9. Contact</h2>
            <p>
              Des questions sur cette politique ? Rejoignez-nous à{' '}
              <a href="mailto:hello@theheartwearstore.ca" className="text-stone-800 underline underline-offset-2 hover:text-stone-900">
        ...
        <div className="prose prose-stone max-w-none space-y-10 text-stone-600 text-[0.95rem] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">1. Who we are</h2>
            <p>
              The Heartwear Store (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) operates the website{' '}
              <span className="font-medium text-stone-700">www.theheartwearstore.ca</span>. We are a Canadian print-on-demand clothing brand. This Privacy Policy explains how we collect, use, and protect your personal information when you visit our site or make a purchase.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">2. Information we collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">3. How we use your information</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">4. Third-party services</h2>
            <p>We work with trusted partners to deliver our service:</p>
            <ul className="list-disc pl-5 space-y-1.5">
              <li><span className="font-medium text-stone-700">Stripe</span> — payment processing. Your payment data is handled entirely by Stripe and is subject to their privacy policy.</li>
              <li><span className="font-medium text-stone-700">Printify</span> — print and fulfillment. Your shipping address is shared with Printify to produce and ship your order.</li>
              <li><span className="font-medium text-stone-700">Netlify</span> — website hosting.</li>
              <li><span className="font-medium text-stone-700">Supabase</span> — secure database for order records.</li>
            </ul>
            <p>Each of these services operates under their own privacy policies and data protection practices.</p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">5. Data retention</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">6. Your rights</h2>
            ...
            <p>To exercise any of these rights, please contact us at <a href="mailto:hello@theheartwearstore.ca" className="text-stone-800 underline underline-offset-2 hover:text-stone-900">hello@theheartwearstore.ca</a>.</p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">7. Cookies</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">8. Changes to this policy</h2>
            <p>
      ...
      <div className="mt-14 pt-8 border-t border-stone-200 flex flex-col sm:flex-row gap-4">
        <Link href="/terms" className="text-sm text-stone-500 hover:text-stone-900 underline underline-offset-2 transition-colors">
          {tr.link_terms}
        </Link>
        <Link href="/contact" className="text-sm text-stone-500 hover:text-stone-900 underline underline-offset-2 transition-colors">
          {tr.link_contact}
        </Link>
      </div>
