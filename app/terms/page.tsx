...
export default function TermsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <div className="mb-12">
        <p className="text-xs uppercase tracking-widest text-sage-600 mb-3">{tr.terms_eyebrow}</p>
        <h1 className="font-playfair text-4xl text-stone-900 mb-4">{tr.terms_heading}</h1>
        <p className="text-stone-500 text-sm">{tr.terms_updated}</p>
      </div>

      {lang === 'fr' ? (
        <div className="space-y-10 text-stone-600 text-[0.95rem] leading-relaxed">

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">1. Aperçu général</h2>
            <p>
              En visitant et en passant une commande sur <span className="font-medium text-stone-700">www.theheartwearstore.ca</span>, vous acceptez d'être lié par ces conditions d'utilisation. Veuillez les lire attentivement. Ces conditions s'appliquent à tous les utilisateurs du site, y compris les visiteurs, les clients et les contributeurs.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">2. Produits</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">3. Prix et paiement</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">4. Expédition et livraison</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">5. Retours et échanges</h2>
            <p>
            ...
            <p>
              Pour demander un échange ou signaler un problème, écrivez-nous à <a href="mailto:hello@theheartwearstore.ca" className="text-stone-800 underline underline-offset-2 hover:text-stone-900">hello@theheartwearstore.ca</a> avec votre numéro de commande et les détails.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">6. Annulations</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">7. Propriété intellectuelle</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">8. Limitation de responsabilité</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">9. Droit applicable</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">10. Modifications des conditions</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">11. Contact</h2>
            <p>
        ...
        <div className="space-y-10 text-stone-600 text-[0.95rem] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">1. Overview</h2>
            <p>
              By visiting and placing an order through <span className="font-medium text-stone-700">www.theheartwearstore.ca</span>, you agree to be bound by these Terms of Service. Please read them carefully. These terms apply to all users of the site, including browsers, customers, and contributors.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">2. Products</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">3. Pricing & payment</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">4. Shipping & delivery</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">5. Returns & exchanges</h2>
            <p>
            ...
            <p>
              To request an exchange or report an issue, email us at <a href="mailto:hello@theheartwearstore.ca" className="text-stone-800 underline underline-offset-2 hover:text-stone-900">hello@theheartwearstore.ca</a> with your order number and details.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">6. Cancellations</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">7. Intellectual property</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">8. Limitation of liability</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">9. Governing law</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-playfair text-xl text-stone-900">10. Changes to these terms</h2>
            <p>
      ...
      <div className="mt-14 pt-8 border-t border-stone-200 flex flex-col sm:flex-row gap-4">
        <Link href="/privacy" className="text-sm text-stone-500 hover:text-stone-900 underline underline-offset-2 transition-colors">
          {tr.link_privacy}
        </Link>
