...
export const t = {
  en: {
    ...
    home_step_3_body: 'Approve the placement you love. Nothing goes live until you say so.',
  ...
  fr: {
    ...
    home_step_3_body: 'Approuvez le placement que vous aimez. Rien n’est publié sans votre accord.',
